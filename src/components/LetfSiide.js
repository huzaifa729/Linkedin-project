...
import Background_Image from "../images/card-bg.svg";
import Background_Photo from "../images/photo.svg";
...
const Photo = styled.div`
  box-shadow: none;
  background-image: url(${Background_Photo});
  width: 72px;
  height: 72px;
